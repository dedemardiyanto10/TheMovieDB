...
public class NowPlayingAdapter extends RecyclerView.Adapter<NowPlayingAdapter.ViewHolder> {
    ...
    public NowPlayingAdapter(Context context, List<NowPlaying> nowPlayingList) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.tvTitle.setText(nowPlaying.getTitle());
        ...
        double rating = nowPlaying.getVoteAverage();
        if (rating == 0.0) {
        ...
        Glide.with(context)
                .load("https://image.tmdb.org/t/p/w780" + nowPlaying.getPosterPath())
