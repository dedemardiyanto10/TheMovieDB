...
public class CastMoviesAdapter extends RecyclerView.Adapter<CastMoviesAdapter.ViewHolder> {
    ...
    private final List<CastMovies> castMoviesList;
    private final Context context;
    private OnItemClickListener onItemClickListener;

    public CastMoviesAdapter(Context context, List<CastMovies> castMoviesList) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.tvTitle.setText(castMovies.getTitle());
        ...
        double rating = castMovies.getVoteAverage();
        if (rating == 0.0) {
        ...
        Glide.with(context)
                .load("https://image.tmdb.org/t/p/w780" + castMovies.getPosterPath())
