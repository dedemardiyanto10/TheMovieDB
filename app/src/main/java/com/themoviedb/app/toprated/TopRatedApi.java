...
public class TopRatedApi {
    private static final String API_BASE_URL = "https://api.themoviedb.org/3/movie/top_rated";
    ...
    public List<TopRated> getTopRatedMovies(int page) throws IOException, JSONException {
        ...
        List<TopRated> topRatedMovies = new ArrayList<>();
