...
public class TopRatedAdapter extends RecyclerView.Adapter<TopRatedAdapter.ViewHolder> {
    ...
    private final List<TopRated> topRatedList;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.tvTitle.setText(topRated.getTitle());
        ...
        double rating = topRated.getVoteAverage();
        if (rating == 0.0) {
        ...
        Glide.with(context)
                .load("https://image.tmdb.org/t/p/w780" + topRated.getPosterPath())
