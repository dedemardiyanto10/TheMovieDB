...
public class AllTrendingAdapter extends RecyclerView.Adapter<AllTrendingAdapter.ViewHolder> {

    private final List<Trending> trendingList;
    private final Context context;
    private OnItemClickListener onItemClickListener;

    public AllTrendingAdapter(Context context, List<Trending> trendingList) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view =
                LayoutInflater.from(parent.getContext())
                        .inflate(R.layout.item_all_trending, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        double rating = trending.getVoteAverage();
        if (rating == 0.0) {
